...
public class WebcrawlerApplication {
	public static void main(String[] args) throws Exception {
		...
		configCrawlerController();
	}

	private static void configCrawlerController() throws Exception {
		...
		// Neo4j AuraDB Free tier has a limit of 200,000 nodes
		...
		/*
		 * This isn't even implemented. I don't know how it got in the example
		 * 
		...
		// CrawlController.WebCrawlerFactory<BasicCrawler> factory = () -> new
		// BasicCrawler(numSeenImages);
